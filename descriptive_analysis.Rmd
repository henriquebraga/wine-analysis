...
Podemos obsXervar algumas diferenças interessantes entre os mesmos: 
...
Outro fator que nos fez dividir o dataset foi a diferença entre a frequência das categorias em relação ao campo `qualidade`.
